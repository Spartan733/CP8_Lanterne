...
## URL de l'API déployé
````
https://cp-8-lanterne-tau.vercel.app/
````
### Résultat
````
{
...
## URL de health
````
https://cp-8-lanterne-tau.vercel.app/api/health
````
### Résultat
````
{
...
## URL de curiosities
````
https://cp-8-lanterne-tau.vercel.app/api/curiosities
````
### Résultat
````
{
...
## URL de recherche
````
https://cp-8-lanterne-tau.vercel.app/api/curiosities?q=Paris
````
### Résultat
````
{
